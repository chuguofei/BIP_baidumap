...
export default {
    ...
    methods: {
        ...
        drawPointLine() {
            ...
            /* if(this.i-1 && this.i && this.i+1 && this.i+2){
                if(this.points[this.i].ssflow !='0.000000' && this.points[this.i+1].ssflow !='0.000000'){
                    if(this.points[this.i-1].ssflow == '0.000000'){
                        this.getFlowArea0(this.points[this.i],this.points[this.i+1],this.points[this.i+2])
                    }
                    if(this.points[this.i-1].ssflow != '0.000000'){
                        // this.getFlowArea1(this.points[this.i-1],this.poins[this.i],this.points[this.i+1],this.points[this.i+2]) 
                    }
                }
                //结尾加喷洒遗留
                if(this.i-1 && this.points[this.i].ssflow != '0.000000'
        ...
        drawArea(data){
            let area = []
            for(let i in data){
                area.push(new BMap.Point(data[i].lng,data[i].lat))
            }
